...
public class PermissionManager {
  ...
  public PermissionManager(QuickShop plugin) {
    ...
    plugin.getLogger().info("Selected permission provider: " +
                            provider.getName());
  }
  ...
  public boolean hasPermission(@NotNull CommandSender sender,
    ...
    try {
      ...
      if (Util.isDevMode()) {
        try {
          PermissionInfomationContainer container =
              provider.getDebugInfo(sender, permission);
          Util.debugLog("Permission Node: " + container.getPermission() +
                        "; Result: " + result +
                        "; Sender: " + container.getSender().getName());
          //                    Util.debugLog("Result: " + result);
          //                    Util.debugLog("Sender: " +
          //                    container.getSender().getName());
          //                    Util.debugLog("Permission Node: " +
          //                    container.getPermission());
          //                    //                    Util.debugLog("Primary
          //                    Group: " + container.getGroupName());
          //                    //                    Util.debugLog("Other
          //                    infos: " + container.getOtherInfos());
        } catch (Exception th) {
