 ...
 * QuickShopItemMatcherImpl.java Copyright (C) PotatoCraft Studio and
 * contributors
 *
...
public class QuickShopItemMatcherImpl implements ItemMatcher {
  ...
  public QuickShopItemMatcherImpl(@NotNull QuickShop plugin) {
    ...
    itemMetaMatcher = new ItemMetaMatcher(
        plugin.getConfig().getConfigurationSection("matcher.item"), this);
   ...
   * @param givenStack   The ItemStack will test matches with original
   *     itemstack.
   * @return The result of tests
   */
  public boolean matches(@Nullable ItemStack[] requireStack,
                         @Nullable ItemStack[] givenStack) {
  ...
  public boolean matches(@Nullable ItemStack requireStack,
    ...
    if (requireStack == null || givenStack == null) {
      Util.debugLog("Match failed: A stack is null: "
                    + "requireStack[" + requireStack + "] givenStack[" +
                    givenStack + "]");
  ...
  private static class ItemMetaMatcher {
    ...
    public ItemMetaMatcher(@NotNull ConfigurationSection itemMatcherConfig,
      ...
      addIfEnable(itemMatcherConfig, "displayname", ((meta1, meta2) -> {
                    ...
                    if (meta1.hasDisplayName()) {
                      return meta1.getDisplayName().equals(
                          meta2.getDisplayName());
                    }
                    return true;
                  }));
      // We didn't touch the loresMatches because many plugin use this check
      // item.
      addIfEnable(itemMatcherConfig, "lores", ((meta1, meta2) -> {
                    ...
                    if (meta1.hasLore()) {
                      ...
                      return Arrays.deepEquals(
                          Objects.requireNonNull(lores1).toArray(),
      ...
      addIfEnable(itemMatcherConfig, "enchs", ((meta1, meta2) -> {
                    ...
                    if (meta1 instanceof EnchantmentStorageMeta !=
                        meta2 instanceof EnchantmentStorageMeta) {
                      return false;
                    }
                    if (meta1 instanceof EnchantmentStorageMeta) {
                      Map<Enchantment, Integer> stor1 =
                          ((EnchantmentStorageMeta)meta1).getStoredEnchants();
                      Map<Enchantment, Integer> stor2 =
                          ((EnchantmentStorageMeta)meta2).getStoredEnchants();
                      return stor1.equals(stor2);
                    }
                    return true;
                  }));
      addIfEnable(
          itemMatcherConfig, "potions", ((meta1, meta2) -> {
            ...
            if (meta1 instanceof PotionMeta) {
              ...
              if (potion1.hasColor() &&
                  !Objects.equals(potion1.getColor(), potion2.getColor())) {
                return false;
              }
              ...
              if (potion1.hasCustomEffects() &&
                  !Arrays.deepEquals(potion1.getCustomEffects().toArray(),
      ...
      addIfEnable(itemMatcherConfig, "attributes", (meta1, meta2) -> {
        ...
        if (meta1.hasAttributeModifiers() && meta2.hasAttributeModifiers()) {
          Set<Attribute> set1 =
              Objects.requireNonNull(meta1.getAttributeModifiers()).keySet();
          Set<Attribute> set2 =
              Objects.requireNonNull(meta2.getAttributeModifiers()).keySet();
          for (Attribute att : set1) {
            if (!set2.contains(att)) {
              return false;
            } else if (!meta1.getAttributeModifiers().get(att).equals(
                           meta2.getAttributeModifiers().get(att))) {
              return false;
            }
          }
        }
      ...
      addIfEnable(itemMatcherConfig, "itemflags",
                  ((meta1, meta2)
                       -> Arrays.deepEquals(meta1.getItemFlags().toArray(),
                                            meta2.getItemFlags().toArray())));
      addIfEnable(
          itemMatcherConfig, "books", ((meta1, meta2) -> {
            ...
            if (meta1 instanceof BookMeta) {
              ...
              if (book1.hasPages() &&
                  !book1.getPages().equals(book2.getPages())) {
                return false;
              }
              ...
              return !book1.hasGeneration() ||
                  Objects.equals(book1.getGeneration(), book2.getGeneration());
            }
            return true;
          }));
      addIfEnable(itemMatcherConfig, "banner", ((meta1, meta2) -> {
                    if (meta1 instanceof BannerMeta != meta2 instanceof
                                                           BannerMeta) {
                      return false;
                    }
                    if (meta1 instanceof BannerMeta) {
                      ...
                      if (bannerMeta1.numberOfPatterns() !=
                          bannerMeta2.numberOfPatterns()) {
                        return false;
                      }
                      return bannerMeta1.getPatterns().containsAll(
                          bannerMeta2.getPatterns());
                    }
                    return true;
                  }));
      addIfEnable(itemMatcherConfig, "skull", (meta1, meta2) -> {
        ...
        if (meta1 instanceof SkullMeta) {
          // getOwningPlayer will let server query playerProfile in server
          // thread Causing huge lag, so using String instead
          String player1 =
              ((SkullMeta)meta1)
                  .getOwner(); // FIXME: Update this when drop 1.15 supports
          String player2 =
              ((SkullMeta)meta2)
                  .getOwner(); // FIXME: Update this when drop 1.15 supports
      ...
      addIfEnable(itemMatcherConfig, "map", (meta1, meta2) -> {
        ...
        if (meta1 instanceof MapMeta) {
          ...
          return !mapMeta1.hasLocationName() || !mapMeta2.hasLocationName() ||
              Objects.equals(mapMeta1.getLocationName(),
                             mapMeta2.getLocationName());
        }
        return true;
      });
      addIfEnable(itemMatcherConfig, "firework", (meta1, meta2) -> {
        if ((meta1 instanceof FireworkMeta) !=
            (meta2 instanceof FireworkMeta)) {
          return false;
        }
        if (meta1 instanceof FireworkMeta) {
      ...
      addIfEnable(itemMatcherConfig, "leatherArmor", ((meta1, meta2) -> {
                    if ((meta1 instanceof LeatherArmorMeta) !=
                        (meta2 instanceof LeatherArmorMeta)) {
                      return false;
                    }
                    if (meta1 instanceof LeatherArmorMeta) {
                      return ((LeatherArmorMeta)meta1)
                          .getColor()
                          .equals(((LeatherArmorMeta)meta2).getColor());
                    }
                    return true;
                  }));
      addIfEnable(itemMatcherConfig, "fishBucket", (meta1, meta2) -> {
        if ((meta1 instanceof TropicalFishBucketMeta) !=
            (meta2 instanceof TropicalFishBucketMeta)) {
          return false;
        }
        if (meta1 instanceof TropicalFishBucketMeta) {
          TropicalFishBucketMeta fishBucketMeta1 =
              ((TropicalFishBucketMeta)meta1);
          TropicalFishBucketMeta fishBucketMeta2 =
              ((TropicalFishBucketMeta)meta2);
          ...
          return !fishBucketMeta1.hasVariant() ||
              (fishBucketMeta1.getPattern() == fishBucketMeta2.getPattern() &&
               fishBucketMeta1.getBodyColor().equals(
                   fishBucketMeta2.getBodyColor()) &&
               fishBucketMeta1.getPatternColor().equals(
                   fishBucketMeta2.getPatternColor()));
        }
        return true;
      });
      addIfEnable(
          itemMatcherConfig, "shulkerBox", ((meta1, meta2) -> {
            // https://www.spigotmc.org/threads/getting-the-inventory-of-a-shulker-box-itemstack.212369
            if ((meta1 instanceof BlockStateMeta) !=
                (meta2 instanceof BlockStateMeta)) {
              return false;
            }
            if (meta1 instanceof BlockStateMeta) {
              if ((((BlockStateMeta)meta1).getBlockState() instanceof
              ...
              if (((BlockStateMeta)meta1).getBlockState() instanceof
                ...
                return itemMatcher.matches(
                    ((ShulkerBox)((BlockStateMeta)meta1).getBlockState())
                        .getInventory()
                        .getContents(),
                    ((ShulkerBox)((BlockStateMeta)meta2).getBlockState())
                        .getInventory()
      ...
      if (!Util.getNMSVersion().equals("v1_13_R1") &&
          !Util.getNMSVersion().equals("v1_13_R2")) {
        addIfEnable(
            itemMatcherConfig, "custommodeldata", ((meta1, meta2) -> {
        ...
        if (!Util.getNMSVersion().equals("v1_14_R1")) {
          addIfEnable(itemMatcherConfig, "suspiciousStew", ((meta1, meta2) -> {
                        if ((meta1 instanceof SuspiciousStewMeta) !=
                            (meta2 instanceof SuspiciousStewMeta)) {
                          return false;
                        }
                        if (meta1 instanceof SuspiciousStewMeta) {
                          SuspiciousStewMeta stewMeta1 =
                              ((SuspiciousStewMeta)meta1);
                          SuspiciousStewMeta stewMeta2 =
                              ((SuspiciousStewMeta)meta2);
                          if (stewMeta1.hasCustomEffects() !=
                              stewMeta2.hasCustomEffects()) {
                            return false;
                          }
                          if (stewMeta1.hasCustomEffects()) {
                            return stewMeta1.getCustomEffects().equals(
    ...
    private void addIfEnable(ConfigurationSection itemMatcherConfig,
