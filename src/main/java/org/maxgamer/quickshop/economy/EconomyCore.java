...
public interface EconomyCore {
   ...
   */
  boolean deposit(@NotNull UUID name, double amount, @NotNull World world,
   ...
   */
  String format(double balance, @NotNull World world,
                @Nullable String currency);
   ...
   */
  double getBalance(@NotNull UUID name, @NotNull World world,
                    @Nullable String currency);
   ...
   * @return Their current balance.
   */
  double getBalance(@NotNull OfflinePlayer player, @NotNull World world,
                    @Nullable String currency);
   ...
   *     receive the funds)
   */
  default boolean transfer(@NotNull UUID from, @NotNull UUID to, double amount,
                           @NotNull World world, @Nullable String currency) {
    if (!isValid()) {
      return false;
    }
   ...
   */
  boolean withdraw(@NotNull UUID name, double amount, @NotNull World world,
                   @Nullable String currency);
