...
public abstract class DisplayItem {
  ...
  checkIsGuardItemStack(@Nullable final ItemStack itemStack) {
   ...
   */
  public static boolean
  checkIsTargetShopDisplay(@NotNull final ItemStack itemStack,
                           @NotNull Shop shop) {
    if (!plugin.isDisplay()) {
      return false;
    }
   ...
   */
  @NotNull
  public static ItemStack createGuardItemStack(@NotNull ItemStack itemStack,
                                               @NotNull Shop shop) {
    itemStack = itemStack.clone();
    // itemStack.setAmount(1);
    ItemMeta iMeta = itemStack.getItemMeta();
    ...
    ShopProtectionFlag shopProtectionFlag =
        createShopProtectionFlag(itemStack, shop);
   ...
   */
  @NotNull
  public static ShopProtectionFlag
  createShopProtectionFlag(@NotNull ItemStack itemStack, @NotNull Shop shop) {
    return new ShopProtectionFlag(shop.getLocation().toString(),
                                  Util.serialize(itemStack));
  }
   ...
   */
  public void pendingRemoval() { pendingRemoval = true; }
