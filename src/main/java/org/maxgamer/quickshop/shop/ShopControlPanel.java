...
public class ShopControlPanel {
  private final Map<Plugin, TreeSet<Entry>> panelRegistry =
      new ConcurrentHashMap<>();
  private final QuickShop plugin;

  public ShopControlPanel(QuickShop plugin) { this.plugin = plugin; }
   ...
   * @param executor  The executor, should returns an QuickComponent or null if
   *     no out-put needs
   */
  public void register(
      @NotNull Plugin namespace, int priority,
      @NotNull Function<Map.Entry<@NotNull CommandSender, @NotNull Shop>,
                        @Nullable QuickComponent> executor) {
   ...
   */
  public void
  unregister(@NotNull Plugin namespace, int priority,
             @NotNull Function<Map.Entry<@NotNull CommandSender, @NotNull Shop>,
                               @Nullable QuickComponent> executor) {
    TreeSet<Entry> entries = this.panelRegistry.get(namespace);
    if (entries == null) {
   ...
   */
  public void
  unregister(@NotNull Plugin namespace,
             @NotNull Function<Map.Entry<@NotNull CommandSender, @NotNull Shop>,
                               @Nullable QuickComponent> executor) {
    TreeSet<Entry> entries = this.panelRegistry.get(namespace);
    if (entries == null) {
  ...
  public static class Entry {
    ...
    private final Function<Map.Entry<@NotNull CommandSender, @NotNull Shop>,
                           @Nullable QuickComponent> executor;
     ...
     */
    @NotNull
    public Function<Map.Entry<@NotNull CommandSender, @NotNull Shop>,
                    @Nullable QuickComponent>
    getExecutor() {
      return executor;
    }
     ...
     *
     * @param data The input data that is an entry contains sender and shop
     *     object
     * @return The QuickComponent or null for no out-put
     */
    @Nullable
    public QuickComponent
    get(@NotNull Map.Entry<@NotNull CommandSender, @NotNull Shop> data) {
