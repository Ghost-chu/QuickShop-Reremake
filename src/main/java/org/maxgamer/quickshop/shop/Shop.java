...
public interface Shop {
   ...
   */
  void buy(@NotNull UUID buyer, @NotNull Inventory buyerInventory,
           @NotNull Location loc2Drop, int paramInt);
  ...
  /**
   * Get shop's owner name, it will return owner name or Admin Shop(i18n) when
   * it is unlimited
   *
   * @param forceUsername Force returns username of shop
   * @return owner name
   */
  @NotNull String ownerName(boolean forceUsername);
   ...
   */
  void sell(@NotNull UUID seller, @NotNull Inventory sellerInventory,
            @NotNull Location loc2Drop, int paramInt);
   ...
   *
   * @return Shop's owner UUID, can use Bukkit.getOfflinePlayer to convert to
   *     the OfflinePlayer.
   */
   ...
   */
  @NotNull String saveExtraToJson();
   ...
   */
  @NotNull Map<String, String> getExtra(@NotNull Plugin plugin);
   ...
   */
  @NotNull ShopExtraManager getExtraManager(@NotNull Plugin plugin);
