...
//
//public class CustomPotionsNamesss {
...
//	
//	private CustomPotionsNamesss() {}
//	
//	public static String getSignName(ItemStack potionItemStack) {
//		org.bukkit.potion.Potion potion = null;
//		potion.apply(potionItemStack);
//		PotionMeta meta = null;
//		if (potion==null) {
//			return "InvalidPotion";
//		}
//		
//		if (potionItemStack.hasItemMeta() && potionItemStack.getItemMeta().hasDisplayName()) {
...
//			type = names.getSign();
//		}
//		Collection<PotionEffect> effect = potion.getEffects();
//		for (PotionEffect potionEffect : effect) {
//			type+=(potionEffect.getAmplifier() >1 ? potionEffect.getAmplifier() : "")+(potionEffect.getDuration()==-1 ? "+" : "");
//		}
//		
//		String variety;
...
//		}
//		
//		String variety = getSignFormat()[1];
//		
